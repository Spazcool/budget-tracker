...
self.addEventListener("fetch", async function(evt) {
  ...
  // let thing = await caches.open('static-cache-v2');
...
//   // let cache = async () =>  caches.match(event.request);
//   // let thing = await cache();
//   // console.log(cache())
//   let anotherthing = caches.match(event.request).then(cache => {
//     return cache;
//   });

//   console.log(anotherthing)
//   event.respondWith(anotherthing || fetch(event.request));
// });